...
drop foreign table if exists syh_geodata_autonomouscommunity;	create FOREIGN TABLE syh_geodata_autonomouscommunity("id" int8 NOT NULL
	,"name" varchar(100) NOT NULL
	,"country_id" int8 NOT NULL)SERVER postgres_fdw_syh OPTIONS (schema_name 'public', table_name 'geodata_autonomouscommunity');
drop foreign table if exists syh_geodata_city;	create FOREIGN TABLE syh_geodata_city("id" int8 NOT NULL
	,"name" varchar(100) NOT NULL
	,"province_id" int8
	,"region_id" int8)SERVER postgres_fdw_syh OPTIONS (schema_name 'public', table_name 'geodata_city');
drop foreign table if exists syh_geodata_country;	create FOREIGN TABLE syh_geodata_country("id" int8 NOT NULL
	,"name" varchar(100) NOT NULL)SERVER postgres_fdw_syh OPTIONS (schema_name 'public', table_name 'geodata_country');
drop foreign table if exists syh_geodata_province;	create FOREIGN TABLE syh_geodata_province("id" int8 NOT NULL
	,"name" varchar(100) NOT NULL
	,"community_id" int8
	,"country_id" int8)SERVER postgres_fdw_syh OPTIONS (schema_name 'public', table_name 'geodata_province');
drop foreign table if exists syh_geodata_region;	create FOREIGN TABLE syh_geodata_region("id" int8 NOT NULL
	,"name" varchar(100) NOT NULL
	,"community_id" int8
	,"province_id" int8)SERVER postgres_fdw_syh OPTIONS (schema_name 'public', table_name 'geodata_region');
drop foreign table if exists syh_geodata_zipcode;	create FOREIGN TABLE syh_geodata_zipcode("id" int8 NOT NULL
	,"code" varchar(10) NOT NULL
	,"city_id" int8)SERVER postgres_fdw_syh OPTIONS (schema_name 'public', table_name 'geodata_zipcode');
...
drop foreign table if exists syh_organizations_organization;	create FOREIGN TABLE syh_organizations_organization("id" uuid NOT NULL
	...
	,"created_by_id" uuid
	,"legal_structure_id" uuid NOT NULL)SERVER postgres_fdw_syh OPTIONS (schema_name 'public', table_name 'organizations_organization');
