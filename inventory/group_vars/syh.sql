...
drop foreign table if exists external.mig_geodata_autonomouscommunity;	create FOREIGN TABLE external.mig_geodata_autonomouscommunity("id" uuid NOT NULL
	...
	,"name_nl" varchar(100)
	,"created_by_id" uuid
	,"country_id" uuid NOT NULL)SERVER postgres_fdw_syh_migration OPTIONS (schema_name 'public', table_name 'geodata_autonomouscommunity');
drop foreign table if exists external.mig_geodata_city;	create FOREIGN TABLE external.mig_geodata_city("id" uuid NOT NULL
	...
	,"created_by_id" uuid
	,"province_id" uuid
	,"region_id" uuid)SERVER postgres_fdw_syh_migration OPTIONS (schema_name 'public', table_name 'geodata_city');
...
drop foreign table if exists external.mig_geodata_province;	create FOREIGN TABLE external.mig_geodata_province("id" uuid NOT NULL
	,"created_at" timestamptz NOT NULL
	,"updated_at" timestamptz NOT NULL
	,"name" varchar(100) NOT NULL
	,"name_en" varchar(100)
	...
	,"country_id" uuid
	,"created_by_id" uuid)SERVER postgres_fdw_syh_migration OPTIONS (schema_name 'public', table_name 'geodata_province');
drop foreign table if exists external.mig_geodata_region;	create FOREIGN TABLE external.mig_geodata_region("id" uuid NOT NULL
	,"created_at" timestamptz NOT NULL
	,"updated_at" timestamptz NOT NULL
	,"name" varchar(100) NOT NULL
	,"name_en" varchar(100)
	...
	,"autonomous_community_id" uuid
	,"created_by_id" uuid
	,"province_id" uuid)SERVER postgres_fdw_syh_migration OPTIONS (schema_name 'public', table_name 'geodata_region');
...
drop foreign table if exists external.mig_organizations_organization;	create FOREIGN TABLE external.mig_organizations_organization("id" uuid NOT NULL
	...
	,"region_id" uuid)SERVER postgres_fdw_syh_migration OPTIONS (schema_name 'public', table_name 'organizations_organization');
